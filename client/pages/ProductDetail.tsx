...
const productData: Record<string, ProductInfo> = {
  ...
  "web-development": {
    ...
    longDescription:
      "This website is a modern, fully responsive company platform built using React for the frontend and Node.js for the backend. It showcases our IT and data analytics services with a clean UI, fast performance, and smooth navigation. The site highlights our company profile, services, team, projects, and contact information, providing clients with a seamless experience to understand what we offer and how we can help their business grow. Designed with a focus on clarity and speed, the website reflects our commitment to delivering high-quality technology solutions.",
    icon: "💻",
    ...
    video: "/videos/aiml.mp4",
    demoLink: "https://www.pyrunai.com",
            ...
            {product.images.gallery.map((image, i) => (
              <Reveal key={i} delay={0.06 * i}>
                <div className="rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition">
                  ...
                  {i === 0 && product.slug === "web-development" && (
                    <div className="mt-4 p-4 bg-green-50 rounded-lg border border-green-100">
                      ...
                      >
                        Dynamic Business Website Powered by React Frontend & Node Backend
                      </a>
                      <p className="text-gray-700 text-sm mt-2">
                        This website is a modern, fully responsive company platform built using React for the frontend and Node.js for the backend. It showcases our IT and data analytics services with a clean UI, fast performance, and smooth navigation. The site highlights our company profile, services, team, projects, and contact information, providing clients with a seamless experience to understand what we offer and how we can help their business grow. Designed with a focus on clarity and speed, the website reflects our commitment to delivering high-quality technology solutions.
                      </p>
