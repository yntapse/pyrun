          ...
          <div className="bg-white rounded-lg border border-gray-200 p-8 sticky top-24">
            ...
            <div className="space-y-6">
              ...
              <div className="border-t border-gray-200 pt-6">
                ...
                <a href="https://www.linkedin.com/company/109349964/" target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 text-blue-600 hover:text-blue-700 font-semibold">LinkedIn Profile →</a>
              </div>
            </div>
